            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 gap-y-10">
                <div class="col-span-2 md:col-span-4 lg:col-span-2">
                    <NuxtLink to="/" class=" flex items-center gap-2">
                        ...
                        <span class="flex">
                            <span class="w-3 h-6 rounded-lg flex bg-primary"></span>
                        </span>
                        <span class="text-xl font-bold text-gray-700 dark:text-white">Podvue</span>
                    </NuxtLink>

                    <p class="text-gray-600 dark:text-gray-300 pt-6">
                        Discover and Enjoy Your Favorite Podcasts Anytime, Anywhere
                    </p>
                </div>
        ...
        <div class="py-2 bg-gray-200 dark:bg-[rgb(10,16,29)]">
            <AtomsContainer>
                <div class="flex justify-between items-center gap-5 text-gray-600 dark:text-gray-300">
                    <div class="">
                        &copy; {{ new Date().getFullYear() }} Developed by <NuxtLink target="_blank"
                            to="#" class="font-bold text-primary">Rommel Canoy</NuxtLink>
                    </div>
                    ...
                    <div class="flex items-center gap-x-3">
                        ...
                        <NuxtLink target="_blank" to="https://github.com/rommelcanoy" class="transition hover:!text-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="w-5 h-5" viewBox="0 0 16 16">
                                <path
