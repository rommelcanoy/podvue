            ...
            <div
                ...
                <div class="mx-auto text-center max-w-xl md:max-w-2xl relative">
                    <h2 class="text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                        Stay Tuned for <span
                            class="text-transparent bg-clip-text bg-gradient-to-br from-primary to-[#8cd66a]">Fresh</span>
                        Content Every Week
                    </h2>
                    <p class="text-gray-600 dark:text-gray-300 pt-8 mx-auto max-w-xl">
                        Our content is designed to keep you updated with the latest trends, insights, and discussions in the tech world. Don’t miss out on our weekly updates that ensure you’re always in the loop and inspired.
                    </p>
