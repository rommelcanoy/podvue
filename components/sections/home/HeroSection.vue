            ...
            <div
                ...
                <div class="lg:py-6">
                    ...
                    <h1 class="text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                        Discover and Enjoy <br> Your Favorite <span
                            class="text-transparent bg-clip-text bg-gradient-to-br from-primary to-[#9a5ccc]">Podcasts</span>
                        Anytime, Anywhere
                    </h1>
                </div>

                <p class="text-gray-600 dark:text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                    Explore a diverse range of podcasts on various topics. From insightful interviews to engaging stories, find the perfect show that fits your interests and enriches your day. Tune in and stay informed, entertained, and inspired.
                </p>
                ...
                <div class="lg:h-full  hidden md:flex">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img src="/images/1.webp" alt="In studio" width="500" height="auto" loading="lazy"
                        ...
                        <div
                            ...
                            <img src="/images/2.webp" alt="Happy in studio" width="200" height="auto"
